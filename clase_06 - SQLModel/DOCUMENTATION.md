...
│   └── users.py             # Definición de tablas `UserDB` y `CountryDB`
...
2. **`models/`**: Define la estructura de las tablas en la base de datos utilizando SQLModel. Aquí encontramos las entidades `UserDB` y `CountryDB` y sus relaciones.
